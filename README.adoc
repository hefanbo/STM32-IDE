...
. [Add source folders] Select *File->New->Folder* from the menu, click *Advanced*, select *Link to alternat location (Linked Folder)*, enter `..\Src` and click *Finish*. Add `..\Inc` and `..\Drivers` in the same way.
